...
export const en: Translations = {
  ...
  settings: 'Settings',
  settingsSessionGroup: 'Session Settings',
  settingsLongBreakGroup: 'Long Break Settings',
  activeTimeLabel: 'Pomodoro',
  restTimeLabel: 'Short Break',
  longBreakTimeLabel: 'Long Break',
  longBreakIntervalLabel: 'Long Break interval',
  ...
  alarmChannelLabel: 'How the alarm rings',
  alarmChannelMedia: 'Normal sound',
  alarmChannelNotification: 'Ring even when screen is off',
  alarmChannelNote: '* When the screen is off or the phone is on silent, "Ring even when screen is off" is more reliable. Notification permission required',
  alarmVolumeSystemControlNote: '* In notification mode, volume is controlled by the system "Notification volume"',
  alarmRepeatLockedNote: '* Notification mode only plays once',
  labelNote: 'Task Note',
  ...
  authNewPassword: 'New password (6+ characters)',
  ...
  authChangePasswordTitle: 'Change your password',
  authPasswordChangeSuccess: 'Password changed successfully',
  authPasswordSameAsCurrent: '⚠ New password is the same as your current password. Continue anyway?',
  authUseSameAnyway: 'Yes, use the same password',
  authSubmitChangePassword: 'Update password',
  authCancel: 'Cancel',
  ...
  freeTrialMenuHint: 'Standard plan — 60 days free',
